    ...
    <div class="content">
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                ...
                <span><i class="mdi mdi-chevron-right"></i></span>Add Service</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <form id="addservice" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-6 form-group">
                                    <label for="Location Name">Service Photo <span><i>(Recommended Size : 400 x 200) Max Size (10MB)</i></span></label>
