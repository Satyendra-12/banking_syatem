    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="homepage-sections fr-view">
                ...
                <a href="{{route("admin.event1")}}" class="btn " style="display: flex;
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="head" style="padding:40px;">
                        <h2 class=" mt-5" style="font-size: 26px;font-weight: bold; text-align:center;">{{ $edit->name }}</h2>
                        <h2 class=" mt-5" style="font-size: 18px; text-align:center;">  Updated On: {{ $edit->date }}</h2>
                    </div>
                </div>
                <div class="col-md-12" style="display:grid;place-content:center;">
                    
                        <img src="{{ asset($edit->image) }}" alt="Forest" width="400" height="400" style="
    width: auto;
    height: auto;
">
                    
                </div>
                <div class="col-md-10" style="display:grid;place-content:center;font-size: 18px;">
                    <p class="mt-5" style="
    font-size: 18px;
