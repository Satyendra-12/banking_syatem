    ...
    <div class="ec-content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1>Listing</h1>
                    <p class="breadcrumb-item" style="color:black;"><span><a href="{{ route('user.dashboard') }}" style="color:black;">Dashboard</a></span><span><a
                                href="{{ route('user.listPage') }}"><i class="mdi mdi-chevron-right" style="color:black;"> Page List
                                        ...
                                        <div id="subcategory">
                                            ...
                                            <select name="subcategor_id" class="form-control" id="subcategor_id">
                                              ...
                                              <option value="{{ $subcategories->id }}"
                                                    {{ $subcategories->id == $edit->subcategory_id ? 'selected' : '' }}>
