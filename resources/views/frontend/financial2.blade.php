...
<style>
    ...
    .line-clamp {
      overflow: hidden;
      display: -webkit-box;
      -webkit-line-clamp: 2; /* Change this number to limit the number of lines */
                ...
                <div class=" w3-display-container">
                    ...
                    {{-- <div class="col-md-12 keepInImage" style="margin-bottom:13px; position: absolute;top:38%;">
                        <h2 class="nomargin text-center streaming-title"
                            ...
                            FINANCIAL SERVICES &gt;&gt; {{ $financial->sub_category_name }}</h2><br>
                    </div>
                                --}}
...
<!-- <div id="container" class="content-container fr-view"> -->
    <a href="{{route("admin.financial")}}" class="btn " style="display: flex;
...
<div class="container mt-7">
                ...
                <div class="row">
                <div class="clearfix">
                    <div class="col-md-12 mt-5"> <input type="hidden" name="id" value="{{ $financial->id }}">
            ...
            <div class="row">
                <div class="clearfix " style="margin-top:45px;">
                    <div class="col-md-12" style="">
                        <p style="font-size: 18px;" class="mb-5">Showing {{ $users->firstItem() }} - {{ $users->lastItem() }} of {{ $users->total() }} Results</p>
                        <h3 class="nomargin text-left mb-5"
                            style="color:rgb(41, 41, 41); font-size: 25px;font-weight: bold;">
                            {{ $financial->sub_category_name }}  Results
                        </h3><br>
            ...
            <div class="row" style="margin-right:0px;margin-left:0px">
                <div class="col-md-9">
                    ...
                    @foreach ($users as $financialdata)
                        
                   
                    <div class="col-xs-12 col-sm-6 col-md-12 member featured-member-info ">

                        <div class="well" 
                            style="background: aliceblue;padding:10px !important;border-radius:15px; overflow:hidden">
                            <div class="clearfix"></div>
                            <div class="col-xs-3 nopad text-center featured-member-image">
                                <img src="{{ asset($financialdata->contact_person) }}" width="200" alt="Bank ABC"
                                    style="height:164px;border:1px solid;">
                                <a title="Bank ABC - View Listing" href="">
                                </a>
                            </div>
                            <div class="col-xs-9 norpad small featured-member-" style="">
                                <a class="h4 bold line-clamp" title="Bank ABC - View Listing" href="#" style="font-size:25px;font-weight:600;">
                                   {{$financialdata->username}}
                                </a>
                                <p class="h4 mt-10 line-clamp" title="Bank ABC - View Listing" href="#"
                                    style="font-size:15px;">
                                    <i class="fa fa-map-marker " aria-hidden="true" style="font-size:16px;padding-top:25px;;color:red"></i>
                                    {{$financialdata->location}},
                                </p>
                                <p class="h4 mt-10 line-clamp" title="Bank ABC - View Listing" href="#" style="font-size:17px;padding-top:21px;;margin-bottom: 2px;">
                                    <i class="fa fa-phone " aria-hidden="true" style="font-size:17px;"></i>
                                 <span class="">{{$financialdata->phone_number}}</span>   

                                </p>
                                <div class="col-xs-12 norpad  featured-member-" style="font-size: 17px;padding-left: 30px;">
                                    <span style="margin-left:-15px; " class="line-clamp">
                                        {{$financialdata->website}}
                                    </span>
                                <span>
                                <a title="Bank ABC - View Listing" class="tmargin btn btn-sm btn-primary btn-block"
                                href="{{ route('admin.fdetails-page' , $financialdata->id ) }}" style="width:fit-content;font-size: 17px;float:right;background:rgb(5,73,142);border-radius:5px;">View
                                Listing</a>
                                </span>
                                </div>
                            </div>
