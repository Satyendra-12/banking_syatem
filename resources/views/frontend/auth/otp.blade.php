                ...
                <div class="col-lg-12 col-md-10">
                    <div class="card">
                        ...
                        <div class="card-body p-5">
                            <h4 class="text-dark mb-5" style="font-weight:600; font-size:30px;">{{ __('lang.enter_otp')}}</h4>
                            ...
                            <form id="otp_verify">
                                ...
                                <div class="row">
                                    <div class="form-group col-12 mb-4">
                                        ...
                                        <input type="number" class="form-control" name="otp" placeholder="{{ __('lang.enter_otp')}}">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-red-cust btn-block mb-4">{{ __("lang.veriry_otp")}}</button>
                                    </div>
                                </div>
                            </form>
