...
<body class="sign-inup" id="body">
            ...
            <div class="col-lg-8 col-md-10">
                <div class="card">
                    ...
                    <div class="card-body p-5">
                        <h4 class="text-dark mb-5" style="font-weight:600; font-size:30px;">{{ __('lang.submit_new_password')}}</h4>

                        <form id="login_newpassword">
                            <input type="hidden" id="userIdInput" name="userIdInput" value="">
                            <div class="row">
                                <div class="form-group col-12 mb-4">
                                    <label for="email">{{ __('lang.password')}}</label>
                                    <input type="password" class="form-control" name="password" placeholder="{{ __('lang.enter_email')}}">
                                </div>

                                <div class="form-group col-md-12 ">
                                    <label for="password">{{ __('lang.confirm_password')}}</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-red-cust btn-block mb-4">{{("lang.submit")}}</button>
    ...
    var userId = urlParts[urlParts.length - 1]; // Assuming the user ID is at the end of the URL
    ...
    // Add an event listener to the button to populate the input field
    ...
    populateButton.addEventListener("click", function() {
        ...
        $(function() {
            ...
            $('#login_newpassword').on('submit', function(e) {
                 alert('hello');
                ...
                $.ajax({
                    url: "{{ route('user.storenewpassword') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
