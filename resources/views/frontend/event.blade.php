                ...
                <div class="container">
                    <div class="clearfix " style="margin-top:15px;">
                        <div class="col-md-12">
                            ...
                            <p style="font-size: 18px; font-size: 18px;margin-bottom: 20px;" class=" mt-5 mb-5">Showing {{ $news->firstItem() }} - {{ $news->lastItem() }} of {{ $news->total() }} Results</p>
                ...
                ">
                 @foreach ($news as $newes)
                    <div class="col-xs-12 col-sm-6 col-md-6 member featured-member-info news-card" style=" margin-right: 15px;">
                        <div class="well card-height" style="position: relative; overflow:hidden; padding: 11px 20px 15px 20px;border-left:5px solid rgb(32, 80, 129);border-right:5px solid rgb(32, 80, 129);">
                            ...
                            {{-- <p class="h4 bold" title="Bank ABC - View Listing" href="#" style="font-size: 17px;color:#204d74;padding-top: 5px;">
                                {{ date('d-m-Y', strtotime($newes->date)) }}
                            </p> --}}

                            <div class="col-xs-4 nopad text-center featured-member-image">
                                <img src="{{ asset($newes->image) }}" width="200" alt="Bank ABC" style="height:150px;width:100%; border-radius: 0px;">
                            ...
                            <div class="col-xs-8 norpad small featured-member-">
                                ...
                                <div class="col-xs-12 norpad  featured-member-">
                                    <p class="clamp-me" style="margin-left:-13px;font-size: 14px;margin-left:-13px;font-size: 14px; ">
                                        {!! $newes->description !!}
                                    </p>
                                </div>
                            </div>

                            <a title="Bank ABC - View Listing" class="tmargin btn btn-sm btn-primary btn-block" href="{{ route('admin.news_and-event', $newes->id) }}"
                             style="position: absolute; bottom:5px;right:5px; width:fit-content;float:right;font-size: 16px;padding: 7px;    background-color: rgba(32, 80, 129,0.95) !important;
