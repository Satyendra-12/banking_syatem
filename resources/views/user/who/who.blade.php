        ...
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <div>
                    ...
                    <a href="{{ route('user.addwho') }}" class="btn btn-sm btn-primary text-white">Add
                        Profile</a>
                                ...
                                <table id="who" class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: black;">Bank/Company Name</th>
...
@section('extra_js')
    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.deletewhou', function(e) {
                e.preventDefault();
                var id = $(this).data('id');
                let fd = new FormData();
            ...
            $('body').on("click", ".changewhoustatus", function(e) {
                e.preventDefault();
                var id = $(this).data('id');
                let fd = new FormData()
                fd.append('_token', "{{ csrf_token() }}");
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: "{{ route('user.who.change.status') }}",
                                type: "POST",
                                data: fd,
                                dataType: 'json',
                                processData: false,
