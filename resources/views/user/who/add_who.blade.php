            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <p class="breadcrumb-item mt-3" style="color: black;"><span><a
                                href="{{ route('user.who') }}" style="color: black;"> Who's Who Profile
            ...
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="addwho" enctype="multipart/form-data">
                                <div class="row">                                    
                                    ...
                                    <div class=" col-6 form-group">
                                        <label for=" Location Name">Position<small>(index page)</small> </label>
                                        <input type="text" class="form-control" name="pos">

                                    </div>
                                    <div class=" col-6 form-group">
                                        <label for=" Location Name">Description</label>
                                        <textarea type="text" class="form-control" id="summernote" name="description"></textarea>
