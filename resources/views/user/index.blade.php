        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
                    <a href="{{ route('admin.registeruser') }}" class="card card-mini dash-card card-1">
                        <div class="card-body" style="text-align: center; color: #fff !important;">
                            <h2 class="mb-1"></h2>
                            <p>Total Users</p>
                        </div>
                    </a>
                ...
                <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
                    <a href="{{ route('admin.categoriesPage') }}" class="card card-mini dash-card card-4">
                        <div class="card-body" style="text-align: center; color: #fff !important;">
                            <h2 class="mb-1"></h2>
                            <p>Inactive Users</p>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
                    <a href="" class="card card-mini dash-card card-3">
                        <div class="card-body" style="text-align: center; color: #fff !important;">
                            <h2 class="mb-1"></h2>
                            <p>Active Users</p>
                        </div>
                ...
                <div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
                    <a href="{{ route('admin.planspage') }}" class="card card-mini dash-card card-4">
                        <div class="card-body" style="text-align: center; color: #fff !important;">
                            <h2 class="mb-1"></h2>
				...
				<div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
                    <a href="{{ route('admin.planspage') }}" class="card card-mini dash-card card-4">
                        <div class="card-body" style="text-align: center; color: #fff !important;">
                            ...
                            <p>Users Awaiting For Approval</p>
                        </div>
                    </a>
                </div>
				<div class="col-xl-3 col-sm-6 p-b-15 lbl-card">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-12 p-b-15">
                    ...
                    <div class="card card-default">
                        <div class="card-header justify-content-center text-white">
                            <h2 style="color: #fff">Most Popular Item</h2>
                        </div>
                        <div class="card-body">
                            <canvas id="doChart"></canvas>
                        </div>
                        <a href="#" class="pb-5 d-block text-center text-muted"><i
                                class="mdi mdi-download mr-2"></i>view All</a>
                ...
                <div class="col-xl-8 col-md-12 p-b-15">
                    ...
                    <div id="user-acquisition" class="card card-default">
                        <div class="card-header text-white">
                            <h2 style="color: #fff">Reported Item</h2>
                        </div>
                        <div class="card-body">
                        ...
                        <tbody>
                             @foreach ($items as $index => $item)
                                <tr>
                                    ...
                                    <td><img src="{{ asset($item->photo) }}" alt="car" height="40px"
                                            width="40px"></td>
										...
										<td>
											<div class="media">
												<div class="media-image mr-3 rounded-circle">
													...
													<img
															class="profile-img rounded-circle w-45"
															src="{{url('assets/img/user/u3.jpg')}}"
															alt="customer image">
															</a>
												</div>
												<div class="media-body align-self-center">
    ...
    <script>
        $(function() {
            ...
            $('#dashboard').dataTable({
                ...
                "ajax": {
                    url: "{{ route('admin.dashboardajaxlist') }}",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                    },
