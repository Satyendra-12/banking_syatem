    ...
    <div class="content">
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                <h1>Add ATM</h1>
                <span>
                <a href="{{ route('user.atm') }}"> ATMs</i></a></span>
                <span><i class="mdi mdi-chevron-right"></i></span>Add ATM</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ec-vendor-list card card-default" style="border: 1px solid rgb(5, 73, 142);">
                    ...
                    <div class="card-body">
                        <form id="addatm" enctype="multipart/form-data">
                            <div class="row">
