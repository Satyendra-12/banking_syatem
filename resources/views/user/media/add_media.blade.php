    ...
    <div class="content">
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                ...
                <span><i class="mdi mdi-chevron-right"></i></span>Add Media</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <form id="addmedia" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                {{-- <div class="col-6 form-group">
                                    <label for="Location Name">Image <span><i>(Recommended Size : 250 x 200) Max Size (10MB)</i></span></label>
...
<script>
    $(function(){
        ...
        $('#addmedia').on('submit', function(e) {
                e.preventDefault()
                let fd = new FormData(this)
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('user.savemedia') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
