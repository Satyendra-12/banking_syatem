    ...
    <div class="content">
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                ...
                <span><i class="mdi mdi-chevron-right"></i></span>Add Feature</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ec-vendor-list card card-default" style="border: 1px solid rgb(5, 73, 142);">
                    ...
                    <div class="card-body">
                        <form id="addfea" enctype="multipart/form-data">
                            <div class="row">
...
<script>
    $(function(){
        ...
        $('#addfea').on('submit', function(e) {
                e.preventDefault()
                let fd = new FormData(this)
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('user.savefeature') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
