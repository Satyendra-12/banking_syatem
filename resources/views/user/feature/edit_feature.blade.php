        ...
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1>Feature</h1>
                    <span>
                            <a href="{{ route('user.feature') }}">Feature</a></span>
                        <span><i class="mdi mdi-chevron-right"></i></span> Edit Feature
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="updatefea" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <textarea type="text" class="form-contro" id="summernote" name="desc"
                                            >{{ $edit->desc }}</textarea>
                                    </div>
...
@section('extra_js')
    <script>
        $(function() {
            $('#updatefea').on('submit', function(e) {
                // alert('hello');
                e.preventDefault()
                let fd = new FormData(this)
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('user.updatefeature') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
