            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <span>
                        ...
                        <span><i class="mdi mdi-chevron-right"></i></span> Edit Management
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="updatemana" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" class="form-control" name="phone" value="{{ $edit->number }}">
...
@section('extra_js')
    <script>
        $(function() {
            $('#updatemana').on('submit', function(e) {
                // alert('hello');
                e.preventDefault()
                let fd = new FormData(this)
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('user.updatemanagement') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
