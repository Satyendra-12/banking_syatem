            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <span>
                        ...
                        <span><i class="mdi mdi-chevron-right"></i></span> Edit Services
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="updatesea" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="summernote" name="desc"
                                            >{{ $edit->desc }}</textarea>
                                    </div>
...
@section('extra_js')
    <script>
        $(function() {
            $('#updatesea').on('submit', function(e) {
                // alert('hello');
                e.preventDefault()
