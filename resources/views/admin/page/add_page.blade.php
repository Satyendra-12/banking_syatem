            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <h1>Page List</h1>
                    <p class="breadcrumb-item mt-3" style="color: black;"><span><a
                                ...
                                href="{{ route('admin.pagepage') }}" style="color: black;"><i class="mdi mdi-chevron-right"> Page List

                                </i>
                            </a></span>
                        <span><i class="mdi mdi-chevron-right">Add Page</i></span>
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="addpage" enctype="multipart/form-data">
                                <div class="row">                                    

                                    <div class=" col-6 form-group">
                                        <label for=" Location Name">Page Details</label>
                                        <input type="text" class="form-control" name="page_name" placeholder="Enter Page Details">
                                    ...
                                    <div class=" col-6 form-group">
                                        ...
                                        <input type="text" class="form-control" name="link" placeholder="Enter Permalink Structure">
