    ...
    <div class="ec-content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1 style="color:#000;">Popular Categories</h1>
                    <p class="breadcrumbs" style="color:#000;"><span><a href="{{ route('admin.dashboard') }}" style="color:#000;">Dashboard</a></span>
                        <span style="color:#000;"><i class="mdi mdi-chevron-right"></i></span>Categories
                    </p>
                </div>
                <div>

                    <a href="{{ url('admin/add-category') }}" class="btn btn-sm btn-primary text-white">Add
                        Category</a>
    ...
    <script>
        $(function() {
            ...
            $('#category').dataTable({
                ...
                "ajax": {
                    url: "{{ route('admin.categoryajaxlist') }}",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                    },
            ...
            $('body').on('click', '.delete_category', function(e) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: "{{ route('admin.deletecategroy') }}",
                                type: "POST",
                                data: fd,
                                dataType: 'json',
                                processData: false,
            ...
            $('body').on("click", ".changesatus_c", function(e) {
                ...
                swal({
                        title: `Confirm!`,
                        text: "Sure you want to change category status?",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
