    ...
    <div class="ec-content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    <h1 style="color:#000;">Post List</h1>
                    <p class="breadcrumbs" style="color:#000;"><span><a href="{{ route('admin.dashboard') }}" style="color:#000;">Dashboard</a></span>
                        <span style="color:#000;"><i class="mdi mdi-chevron-right"></i></span>Post List
                    </p>
                </div>
                <div>

                    <a href="{{ url('admin/add-post') }}" class="btn btn-sm btn-primary text-white" style="border-radius: 0px;padding: 10px;">Publish New Post +</a>
                                ...
                                <table id="post" class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color:#000;">Thumbnail</th>
                                            {{-- <th>No.</th> --}}
                                            <th>Post Details</th>
                                    ...
                                    <tbody>
                                        {{-- @foreach ($get as $key => $c)
                                            <tr>
                                                ...
                                                <td>{{ $c->post_name }}</td>
                                                <td>
                                                    <img src="{{ url('/') . '/storage/app/public/' . $c->post_icon }}"
                                                        alt="logo" width="40px" height="40px">
                                                </td>
                                                <td>
                                                    <a href="{{ route('admin.editpost', $c->id) }}"
    ...
    <script>
        $(function() {
            ...
            $('body').on("click", ".changesatus_c", function(e) {
                ...
                swal({
                        title: `Confirm!`,
                        text: "Sure you want to change post status?",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
