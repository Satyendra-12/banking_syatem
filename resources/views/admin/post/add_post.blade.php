            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <h1>Publish New Post</h1>
                    <p class="breadcrumb-item mt-3" style="color: black;"><span><a
                                ...
                                href="{{ route('admin.postpage') }}" style="color: black;"><i class="mdi mdi-chevron-right"> Post Lists

                                </i>
                            </a></span>
                        <span><i class="mdi mdi-chevron-right">Add Post</i></span>
                    </p>
                </div>
                            ...
                            <form id="addpost" enctype="multipart/form-data">
                                <div class="row">                                    
                                    ...
                                    <div class=" col-6 form-group">
                                        ...
                                        <input type="text" class="form-control" name="post_details" placeholder="Enter Post Details">
