            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <p class="breadcrumb-item mt-3" style="color:black;"><span><a href="{{ route('admin.dashboard') }}" style="color:black;">Dashboard</a></span><span>
                            <a href="{{ route('admin.rbanner') }}"><i class="mdi mdi-chevron-right" style="color:black;">Right Banner</i></a></span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="updatebanner" enctype="multipart/form-data">
                                <div class="row">
                                    <input type="hidden" name="id" value="{{ $banneredit->id }}">
                                    <div class="col-6 form-group">
                                        <label for="Location Name">Banner Photo <span><i>(Recommended Size : 700 x 300) Max
                                                    Size (10MB)</i></span></label>
                                        <input type="file" class="form-control" name="image">
                                        <img src="{{ asset($banneredit->image) }}" alt="error" width="150px"
                                ...
                                {{-- <div class="col-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{$banneredit->name}}">
                                </div> --}}
                                </div>
                                {{-- <div class="row">
                                <div class="col-6"></div>
