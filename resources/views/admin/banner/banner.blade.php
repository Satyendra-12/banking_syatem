        ...
        <div class="content">
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.addbanner') }}" class="btn btn-sm btn-primary text-white">Add Banner</a>
                    ...
                    <div class="ec-vendor-list card card-default">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="banner_tabel" class="table brand_table">
                                    <thead>
                                        <tr>
                                            <th style="color:black;">No</th>
                                            <th style="color:black;">Image</th>
                                            {{-- <th style="color:black;">Youtube Link</th> --}}
    ...
    <script>
        $(function() {
            ...
            $('#banner_tabel').dataTable({
                ...
                "ajax": {
                    url: "{{ route('admin.bannerajaxlist') }}",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                    },
                            ...
                            $.ajax({
                                ...
                                success: function(result) {
                                    if (result.status) {
                                        ...
                                        $('#banner_tabel').DataTable().ajax.reload();
