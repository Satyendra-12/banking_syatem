            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <h1>Add List</h1>
                    <p class="breadcrumb-item mt-3" style="color: black;"><span><a
                                ...
                                href="{{ route('admin.listPage') }}" style="color: black;"><i class="mdi mdi-chevron-right"> Lists
                        ...
                        <div class="card-body">
                            <form id="addlist" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('admin.listPage') }}" class="btn btn-primary btn-sm">cancel</a>
                                </div>
                                </div>
                            </form>
