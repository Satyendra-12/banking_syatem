            ...
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="updateslider" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6 form-group">
                                        <input type="hidden" name="id" value="{{$editslider->id}}">
                                        <label for="Location Name">Slider Photo <span><i>(Recommended Size : 1400 x 600) Max
                                                    Size (10MB)</i></span></label>
                                        <input type="file" class="form-control" name="image">
                                        <img src="{{ asset($editslider->image) }}" alt="error" width="150px"
