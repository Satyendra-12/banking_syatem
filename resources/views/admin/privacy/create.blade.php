        ...
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                ...
                <p class="breadcrumb-item mt-3" style="color:black;"><span><a href="{{ route('admin.dashboard') }}" style="color:black;">Dashboard</a></span>
                    <span><a href="{{ route('admin.dashboard') }}"><i class="mdi mdi-chevron-right" style="color:black;">Privacy</i></a></span>
                    <span><i class="mdi mdi-chevron-right">Add Privacy</i></span></p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ec-vendor-list card card-default">
                    ...
                    <div class="card-body">
                        <form action="{{ route('privacy.save.update') }}" method="POST" >
                            @csrf
                            <div class="row">
