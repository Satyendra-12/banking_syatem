            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <p class="breadcrumb-item" style="color:black;"><span><a href="{{ route('admin.dashboard') }}" style="color:black;">Dashboard</a></span><span><a
                                href="{{ route('admin.whoPage') }}"><i class="mdi mdi-chevron-right" style="color:black;"> Who's Who Profile
                            ...
                            <form id="updatewho" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class=" col-6 form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="summernote" name="full_description"
                                            >{!! $edit->full_description !!}</textarea>
                                    </div>
