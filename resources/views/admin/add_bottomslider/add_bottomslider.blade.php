    ...
    <div class="content">
        <div class="breadcrumb-wrapper breadcrumb-contacts">
            <div>
                ...
                <span><i class="mdi mdi-chevron-right"></i></span>Add Bottom Slider</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="ec-vendor-list card card-default">
                    ...
                    <div class="card-body">
                        <form id="addbottomslider" enctype="multipart/form-data">
                            <div class="row">
                                
                                <div class="col-6 form-group">
                                    <label for="Location Name">Slider Photo <span><i>(Recommended Size : 1350 x 300) Max Size (10MB)</i></span></label>
...
<script>
    $(function(){
        ...
        $('#addbottomslider').on('submit', function(e) {
                e.preventDefault()
                let fd = new FormData(this)
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('admin.storebottomslider') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
