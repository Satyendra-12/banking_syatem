            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <p class="breadcrumb-item" style="color:black;"><span><a href="{{ route('admin.dashboard') }}" style="color:black;">Dashboard</a></span><span><a
                                href="{{ route('admin.articlespage') }}"><i class="mdi mdi-chevron-right" style="color:black;">All Events

                                </i>
                            </a></span>
                        <span><i class="mdi mdi-chevron-right"></i></span>Update Events
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="updatearticles" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group">
                                     ...
                                     <div class=" col-6 form-group">
                                        <label for=" Location Name">Events Photo</label>
...
@section('extra_js')
    <script>
            ...
            $('#updatearticles').on('submit', function(e) {
                //   alert('hello');
                e.preventDefault()
                let fd = new FormData(this)
                fd.append('_token', "{{ csrf_token() }}");
                $.ajax({
                    url: "{{ route('admin.updatearticles') }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
