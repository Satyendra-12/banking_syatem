            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                ...
                <h1>Add Events</h1>
                    <p class="breadcrumb-item mt-3" style="color: black;"><span><a
                                ...
                                href="{{ route('admin.articlespage') }}" style="color: black;"><i class="mdi mdi-chevron-right"> Events

                                </i>
                            </a></span>
                        <span><i class="mdi mdi-chevron-right">Add Events</i></span>
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="ec-vendor-list card card-default">
                        ...
                        <div class="card-body">
                            <form id="addarticles" enctype="multipart/form-data">
                                <div class="row">                

                                    <div class="col-6 form-group">
                                        <label for=" Location Name">Events Name </label>
                                    ...
                                    <div class="col-6 form-group">
                                     ...
                                     <div class=" col-6 form-group">
                                        <label for=" Location Name">Events Image</label>
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <textarea class="form-control" id="summernote" name="full_description" placeholder="Enter Description">
                                        </textarea>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('admin.articlespage') }}" class="btn btn-primary btn-sm" style="color:white !important;">cancel</a>
                                </div>
                                </div>
                            </form>
...
@section('extra_js')
    ...
    <script>
        ...
        $(function() {
            $('#addarticles').on('submit', function(e) {
                e.preventDefault()
                //  alert('hello');
