            ...
            <div class="breadcrumb-wrapper breadcrumb-contacts">
                <div>
                    ...
                    <p class="breadcrumb-item mt-3" style="color:black;">
                        ...
                        <span><a href="{{ route('contact-us.index') }}"><i class="mdi mdi-chevron-right" style="color:black;">Contact Message</i></a></span>
...
<script>
        $(function() {
            $('#updatecontact').on('submit', function(e) {
                ...
                fd.append('id', "{{ $contactus->id }}");
                $.ajax({
                    url: "{{ route('contact.update', $contactus->id) }}",
                    type: "POST",
                    data: fd,
                    dataType: 'json',
                    processData: false,
